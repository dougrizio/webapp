...
def index():
    user = {'username': 'Old Faithful Geyser Data'}
...
def form_update_post(city_id):
    ...
    sql_update_query = """UPDATE tblFaithfulImport t SET t.fldName = %s, t.fldLat = %s, t.fldLong = %s, t.fldCountry = 
...
def form_insert_post():
    ...
    sql_insert_query = """INSERT INTO tblFaithfulImport (fldName,fldLat,fldLong,fldCountry,fldAbbreviation,fldCapitalStatus,fldPopulation) VALUES (%s, %s,%s, %s,%s, %s,%s) """
